...
export const highlights: Highlight[] = [
  ...
  },
  {
    ...
    thought:
      "<a href='https://www.instagram.com/livingbybike/'>Claire/LivingByBike</a> hosted an awesome (but COLD) trip in Montgomery County, MD, November 2024.",
    type: 'photos',
    image:
      'https://lh3.googleusercontent.com/pw/AP1GczPbA2i14en8ZLs4IPORBIb_K_BFUt6CUzkgekI3cw1kRrK9CDPbhRtRnAHEbjiTDWylaoNkuj3rTiHO7uzsTv9aqFI0q78sKZpHUL7MKMy67OgKyuDJkaKkxO1mnEENDYNSbeJyDXRg9appOmIdvdcJ9Q=w1158-h674-s-no?authuser=0',
  },
  {
    ...
    thought:
      "<a href='https://718outdoors.com/'>Joe's 718 Outdoors</a> Micro-tour 10, Labor Day 2024",
    type: 'photos',
    image:
      'https://lh3.googleusercontent.com/pw/AP1GczM8KUevAUq-G0KxMYkIWlLAxC4AKpeY1PiZm05YjXVwgEFqQ78ZrY0kYtoexa9PftO0P1_B-yPNLsLVEDbIF9FIcV3wKG7eIIEW8KlsJkhc5ov1oMwWWQGo_8SwmJvA5Nilc3qWtBjOcROMevKxO-CTwQ=w1158-h709-s-no?authuser=0',
  },
  {
    ...
    type: 'photos',
    image:
      'https://lh3.googleusercontent.com/pw/AP1GczNEF9t32AJ3PmlRIMTW6kP0I1zuakUZDglTod7TSq11m5NDyH1zp9jQnI76CnJwDoSs7P1DAmYFmDM1goHM8QjSrp2MsD1Al80KP9_lB9vOcib1c-oyINJjZKPXayLnV6UcX4i0w-hulXl5pg-8pNo8Tg=w1158-h770-s-no?authuser=0',
  },
  {
    ...
    type: 'photos',
    image:
      'https://lh3.googleusercontent.com/pw/AP1GczNDCwGQDQW7Gt-ZWDOuDmAqHilstB0NFb2ki4w5lfy7JClyhYJ6EpGI1Hd5YJfxIL7Len2ZViogSA7XDzBa4tp0sFByvjCH1evjsdfv8TJvB5hkDmFQlrOiUWIJ0-zhX9RIk05uuzrPcsOIZE9FC9GeGA=w1158-h640-s-no?authuser=0',
  },
  {
    ...
    type: 'photos',
    image:
      'https://lh3.googleusercontent.com/pw/AP1GczPNrRQUR15ZdCLDz2HqNGhg2q4h2i-jSnyZrQsmskmLvVwr_5ei1Ne5r4Sj08GtlXwZSxowQLayACbi1dinNjdoenj8ARDLwjrr9lzBGijgV7f4ITTm_mTaIRR9x6gA3Yo3YvNcynIxymfOFAFTsQPuQg=w1158-h771-s-no?authuser=0',
  },
];
...
export function getHighlightIcon(type: string) {
  switch (type) {
    case 'code':
      return `<svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline></svg>`;
    case 'photos':
      return `<svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>`;
    default:
      return null;
  }
}
