export const MY_TEAMS = [
  {
    league: 'MLB',
    name: 'Red Sox',
    url: 'https://www.mlbtraderumors.com/boston-red-sox/feed/atom',
  },
  ...
  { league: 'NBA', name: 'Celtics', url: 'https://www.hoopsrumors.com/bostonceltics.xml' },
  {
    league: 'MLB',
    name: 'Orioles',
    url: 'https://www.mlbtraderumors.com/baltimore-orioles/feed/atom',
  },
  ...
  { league: 'NBA', name: 'Wizards', url: 'https://www.hoopsrumors.com/washingtonwizards.xml' },
  {
    league: 'MLB',
    name: 'White Sox',
    url: 'https://www.mlbtraderumors.com/chicago-white-sox/feed/atom',
  },
] as const;
...
export const TEAM_LOGOS: Record<string, string> = {
  ...
  'Baltimore Orioles':
    'https://a.espncdn.com/combiner/i?img=/i/teamlogos/mlb/500/bal.png&w=40&h=40',
  ...
  'Chicago White Sox':
    'https://a.espncdn.com/combiner/i?img=/i/teamlogos/mlb/500/chw.png&w=40&h=40',
  Spurs: 'https://a.espncdn.com/combiner/i?img=/i/teamlogos/nba/500/sas.png&w=40&h=40',
  'San Antonio Spurs':
    'https://a.espncdn.com/combiner/i?img=/i/teamlogos/nba/500/sas.png&w=40&h=40',
  ...
  'Washington Wizards':
    'https://a.espncdn.com/combiner/i?img=/i/teamlogos/nba/500/wsh.png&w=40&h=40',
};
