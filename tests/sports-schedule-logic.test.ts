...
describe('Sports Schedule Logic', () => {
  ...
  it('should correctly identify a recent win', async () => {
          ...
          competitions: [
            {
              ...
              competitors: [
                ...
                {
                  homeAway: 'away',
                  team: { id: '99', displayName: 'Blue Jays' },
    ...
    (global.fetch as any).mockImplementation((url: string) => {
      ...
      if (url.includes('/teams/2'))
        return Promise.resolve({ ok: true, json: () => Promise.resolve(mockTeam) });
      ...
      competitions: [
        {
          status: { type: { completed: true } },
          competitors: [
            { homeAway: 'home', team: { id: '2' }, score: '5', winner: true },
            { homeAway: 'away', team: { id: '99' }, score: '3' },
          ],
        },
      ],
    };
      ...
      competitions: [
        {
          status: { type: { completed: true } },
          competitors: [
            { homeAway: 'home', team: { id: '2' }, score: '2', winner: false },
            { homeAway: 'away', team: { id: '98' }, score: '4' },
          ],
        },
      ],
    };
